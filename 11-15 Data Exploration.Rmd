...
```
Both variables show a high Spearman rank correlation with lifetime giving.  I will ue the Velocity35Score in the regression model since it's rank score is slightly higher and it has a less skewed distribution than the Velocity57Score.
...
Since it is unlikely to have any predidictive value for giving, the variable GENDER will not be included in the regression model.  
